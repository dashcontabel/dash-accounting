...
async function main() {
  ...
  const PROD_MAPPINGS = [
    ...
    { dashboardField: "IOF_IRRF",              matchType: "LIST"   as const, codes: ["3.2.2.05.001", "3.2.2.05.004", "3.2.2.05.006"], valueColumn: "debito" as const, aggregation: "ABS_SUM" as const, isCalculated: false, formula: null },
    ...
    { dashboardField: "DISTRIB_LUCROS",        matchType: "LIST"   as const, codes: ["1.1.3.04.001", "2.3.50.100.1"],   valueColumn: "debito"       as const, aggregation: "SUM"     as const, isCalculated: false, formula: null, showInCostCenter: false },
