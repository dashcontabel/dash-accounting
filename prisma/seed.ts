...
async function main() {
  ...
  const PROD_MAPPINGS = [
    ...
    { dashboardField: "DISTRIB_LUCROS",        matchType: "PREFIX" as const, codes: ["1.1.3.04.001"],                    valueColumn: "debito"       as const, aggregation: "SUM"     as const, isCalculated: false, formula: null },
